...
class _ResponsiveExpandableLayoutState
  ...
  void _toggleExpand() {
    setState(() {
      ...
      if (_isExpanded) {
        // Automatically hide the software keyboard when preview is expanded
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        // Background: First Panel (Input)
        Positioned(
          top: 0,
          left: 0,
          right: 0,
          // Leave room at the bottom so the collapsed card doesn't hide text
        ...
        // Dark Overlay Scrim when expanded
        if (_isExpanded)
          Positioned.fill(
        ...
        // Foreground: Second Panel (Expandable Card)
        AnimatedPositioned(
          ...
          left: 0,
          right: 0,
          height: _isExpanded ? MediaQuery.sizeOf(context).height * 0.8 : 56,
          child: Container(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        kGapSmall,
                        Text(widget.expandTitle, style: AppTextStyles.b2.bold),
                        const Spacer(),
                        Icon(
                          _isExpanded
